...
if (printPlan) {
  console.log(JSON.stringify({ command: plan.command, args: plan.args, artifactTarget: plan.artifactTarget, artifactFileName: plan.artifactFileName, usesGlibcFloor: plan.usesGlibcFloor }));
  process.exit(0);
}
